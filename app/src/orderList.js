...
import {  Modal, StyleSheet, Text, View, TouchableOpacity, Image, ScrollView, FlatList, CheckBox, ActivityIndicator } from 'react-native';
...
export default class OrderList extends Component{
  ...
  componentDidMount(){
    ...
    const data = navigation.getParam('barcode', 'NO-ID');

    fetch('http://ec2-13-127-158-175.ap-south-1.compute.amazonaws.com:8080/getOrderData?barcode_no='+data)
    ...
    if(this.state.error === false && this.state.loading === false)
    {
      return(
        <View style={{flex:1,backgroundColor:'white'}}>
          ...
          <Text style={styles.name}>T.J. Maxx & HomeGoods</Text>
          ...
          <View style={{borderColor:'black',borderWidth:1,margin:10,padding:5,flexDirection:'row'}}>
            <View style={{flex:1}}>
              <Text style={styles.keyText}>Order Date</Text>
              <Text style={styles.keyText}>Receipt Number</Text>
              <Text style={styles.keyText}>Order Total</Text>
          ...
          <TouchableOpacity style={styles.submitButton} onPress={()=>this.setState({modalVisible:true})}>
            <Text style={styles.submitText}>Generate Returns Invoices</Text>
          </TouchableOpacity>
          ...
          <View style={{marginTop: 22,backgroundColor:'white',padding:20}}>
              <Text style={{fontSize:20,fontWeight:'bold',margin:10,color:'#258c42'}}>Do you want to generate returns?</Text>
              ...
              <View style={{flexDirection:'row'}}>
                ...
                <View style={{flex:1,alignItems:'center',flexDirection:'row'}}>
                  ...
                  <TouchableOpacity style={{margin:10}}
                    ...
                    <Text style={{paddingTop:10,paddingBottom:10,color:'black',fontSize:18}}>Close</Text>
                  </TouchableOpacity>

                  <TouchableOpacity style={{margin:10}}
                    onPress={this.handleSubmit}>
                    <Text style={{paddingTop:10,paddingBottom:10,color:'black',fontSize:18}}>Continue</Text>
                  </TouchableOpacity>
                </View>
              </View>
